...
int main(int argc, const char *argv[]) {
    ...
    // Obtener el código IR generado (asumiendo que HaploRustDriver lo almacena)
    string ir_code = driver->getIR(); // Asegúrate de tener este método en tu driver
    ...
    // Paso 1: Optimizar el IR (Nivel 1)
    ...
    // Paso 2: Compilar el IR optimizado a assembler
    ...
    // Paso 3: Generar el ejecutable final usando clang
    ...
    // Limpieza de archivos intermedios si lo deseas
    // remove(optimized_ir.c_str());
